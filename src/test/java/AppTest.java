...
public class AppTest {
    ...
    @DisplayName("Testing the password contains at least one number")
    void testForNumber() {
    ...
    @DisplayName("Testing for not allowed special characters")
    void testForSpecialCharacters() {
        assertFalse(App.checkPassword("Pasd111:" + specificCharacter), "The method must return false if " +
                "not allowed specific characters are used.");
    }
    @Test
    @DisplayName("Testing for special characters")
